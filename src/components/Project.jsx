      ...
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col items-center bg-[#F2EFE5] p-6 rounded-2xl shadow-lg">
            <h1 className="text-[#fe5617] font-extrabold text-[32px] mb-4">Agro</h1>
          ...
          {/* R & D */}
          <div className="flex flex-col items-center bg-[#F2EFE5] p-6 rounded-2xl shadow-lg">
            <h1 className="text-[#fe5617] font-extrabold text-[32px] mb-4">R & D</h1>
            <p className="text-lg text-gray-700 mb-4">
          ...
          {/* gadget-grove */}
          <div className="flex flex-col items-center bg-[#F2EFE5] p-6 rounded-2xl shadow-lg">
            <h1 className="text-[#fe5617] font-extrabold text-[32px] mb-4">Gadget-Grove</h1>
            <p className="text-lg text-gray-700 mb-4">
          ...
          {/* CoderLobby Project */}
          <div className="flex flex-col items-center bg-[#F2EFE5] p-6 rounded-2xl shadow-lg">
            <h1 className="text-[#fe5617] font-extrabold text-[32px] mb-4">process</h1>
            <p className="text-lg text-gray-700 mb-4">
